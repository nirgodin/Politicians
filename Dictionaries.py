...
politicians_dct = {'Abou-Shahadeh': ['ShahadehAbou', 'Meshutefet', 'Male', 'אבו-שחאדה', 13, '19/12/1975'],
                   ...
                   'Elharrar': ['KElharrar', 'Yesh_Atid', 'Female', 'אלהרר', 16, '09/10/1977'],
                   ...
                   'Ashkenazi': ['Gabi_Ashkenazi', 'Kachol_Lavan', 'Male', 'אשכנזי', 4, '25/02/1954'],
                   ...
                   'Barbivay': ['OrnaBarb', 'Yesh_Atid', 'Female', 'ברביבאי', 10, '05/09/1962'],
                   'Barak': ['KerenBarak', 'Likud', 'Female', 'ברק', 26, '20/09/1972'],
                   'Barkat': ['NirBarkat', 'Likud', 'Male', 'ברקת', 9, '19/10/1959'],
                   'Golan_Yair': ['YairGolan1', 'Meretz', 'Male', 'גולן יאיר', 7, '14/05/1962'],
                   'Golan_May': ['GolanMay', 'Likud', 'Female', 'גולן מאי', 34, '03/05/1986'],
                   'Ginzburg': ['EitanGinzburg', 'Kachol_Lavan', 'Male', 'גינזבורג', 32, '25/01/1977'],
                   ...
                   'Hauser': ['ZviHauser', 'Derech_Eretz', 'Male', 'האוזר', 14, '05/07/1968'],
                   'Horowitz': ['NitzanHorowitz', 'Meretz', 'Male', 'הורוביץ', 3, '24/02/1965'],
                   'Halevi': ['HaleviAmit', 'Likud', 'Male', 'הלוי', 39, '05/06/1971'],
                   'Hanegbi': ['Tzachi_Hanegbi', 'Likud', 'Male', 'הנגבי', 15, '26/02/1957'],
                   'Hendel': ['YoazHendel1', 'Derech_Eretz', 'Male', 'הנדל', 9, '22/05/1975'],
                   'Haskel': ['SharrenHaskel', 'Tikva_Chadasha', 'Female', 'השכל', 30, '04/03/1984'],
                   'Cotler-Wunsh': ['CotlerWunsh', 'Kachol_Lavan', 'Female', 'וונש', 36, '18/12/1970'],
                   'Zohar': ['zoharm7', 'Likud', 'Male', 'זוהר', 28, '28/03/1980'],
                   'Zamir': ['asafzamir', 'Kachol_Lavan', 'Male', 'זמיר', 19, '31/08/1980'],
                   'Zandberg': ['tamarzandberg', 'Meretz', 'Female', 'זנדברג', 4, '29/04/1976'],
                   ...
                   'Haimovich': ['mikihaimovich1', 'Kachol_Lavan', 'Female', 'חיימוביץ', 7, '15/06/1962'],
                   'Turpaz': ['mosheturpaz', 'Yesh_Atid', 'Male', 'טורפז', 42, '29/04/1972'],
                   'Toporovsky': ['BToporovsky', 'Yesh_Atid', 'Male', 'טופורובסקי', 30, '17/07/1980'],
                   ...
                   'Yankelevitch': ['omeryankelevitc', 'Kachol_Lavan', 'Female', 'ינקלביץ', 23, '25/05/1978'],
                   'Yaalon': ['bogie_yaalon', 'Yesh_Atid', 'Male', 'יעלון', 3, '24/06/1950'],
                   'Yatom': ['DannyYatom', 'Vatikei_Israel', 'Male', 'יתום', 1, '15/03/1945'],
                   'Cohen_Eli': ['elicoh1', 'Likud', 'Male', 'כהן אלי', 14, '03/10/1972'],
                   'Cohen_Meir': ['MKmeircohen', 'Yesh_Atid', 'Male', 'כהן מאיר', 6, '15/11/1955'],
                   'Cohen_Meirav': ['cohen_meirav', 'Yesh_Atid', 'Female', 'כהן מירב', 17, '26/08/1983'],
                   'Cohen_Roee': ['roee_cohen19', 'Tnufa', 'Male', 'כהן רועי', 2],
                   'Kahana': ['MatanKahana', 'Yamina', 'Male', 'כהנא', 5, '29/07/1972'],
                   ...
                   'Lahav-Hertzanu': ['YoraiLahav', 'Yesh_Atid', 'Male', 'להר-הרצנו', 35, '05/08/1988'],
                   'Levy': ['MKMickeyLevy', 'Yesh_Atid', 'Male', 'לוי', 22, '21/06/1951'],
                   'Levy-Abekasis': ['Orly_levy', 'Gesher', 'Female', 'לוי-אבקסיס', 2, '11/11/1973'],
                   'Liberman': ['AvigdorLiberman', 'Israel_Beytenu', 'Male', 'ליברמן', 1, '05/06/1958'],
                   'Lapid': ['yairlapid', 'Yesh_Atid', 'Male', 'לפיד', 2, '05/11/1963'],
                   'Mark': ['OsnathilaMark', 'Likud', 'Female', 'מארק', 38, '22/09/1967'],
                   'Mulla': ['FateenMulla', 'Likud', 'Male', 'מולא', 33, '15/06/1960'],
                   'Michaeli': ['MeravMichaeli', 'Avoda', 'Female', 'מיכאלי', 6, '24/11/1966'],
                   ...
                   'Nissenkorn': ['AviNissenkorn', 'Haisraelim', 'Male', 'ניסנקורן', 5, '20/03/1967'],
                   'Netanyahu': ['netanyahu', 'Likud', 'Male', 'נתניהו', 1, '21/10/1949'],
                   'Segalovitz': ['YSegalovitz', 'Yesh_Atid', 'Male', 'סגלוביץ', 28, '23/04/1959'],
                   'Sova': ['evgenysova', 'Israel_Beytenu', 'Male', 'סובה', 3, '29/08/1980'],
                   'Sofer': ['ofir_sofer', 'Yamina', 'Male', 'סופר', 6, '01/08/1974'],
                   'Smotrich': ['bezalelsm', 'Yamina', 'Male', 'סמוטריץ', 4, '27/02/1980'],
                   ...
                   'Froman': ['mkorlyfroman', 'Yesh_Atid', 'Female', 'פרומן', 31, '14/06/1955'],
                   'Friedman': ['TehilaFriedman', 'Kachol_Lavan', 'Female', 'פרידמן', 38, '11/06/1976'],
                   'Peretz_Amir': ['amirperetz', 'Avoda', 'Male', 'פרץ עמיר', 1, '09/03/1952'],
                   'Peretz_Rafi': ['realrafiperets', 'Bait_Yehudi', 'Male', 'פרץ רפי', 2, '07/01/1956'],
                   ...
                   'Roll': ['idanroll', 'Yesh_Atid', 'Male', 'רול', 34, '27/04/1984'],
                   'Razvozov': ['YRazvozov', 'Yesh_Atid', 'Male', 'רזבוזוב', 18, '05/07/1980'],
                   ...
                   'Stern': ['Elazar_stern', 'Yesh_Atid', 'Male', 'שטרן', 21, '25/08/1956'],
                   'Shay-Vazan': ['HVazan', 'Kachol_Lavan', 'Female', 'שי-וזאן', 39, '16/04/1980'],
                   'Shir': ['MichalShir', 'Tikva_Chadasha', 'Female', 'שיר', 31, '18/11/1979'],
                   'Shelah': ['OferShelah', 'Tnufa', 'Male', 'שלח', 8, '09/02/1960'],
                   'Shmuli': ['ishmuli', 'Avoda', 'Male', 'שמולי', 5, '08/02/1980'],
                   'Shefa': ['ramshefa', 'Kachol_Lavan', 'Male', 'שפע', 29, '15/02/1985'],
                   'Shaked': ['Ayelet__Shaked', 'Yamina', 'Female', 'שקד', 3, '07/05/1976'],
                   'Touma-Sliman': ['AidaTuma', 'Meshutefet', 'Female', 'תומא-סלימאן', 5, '16/07/1964'],
                   'Tamano-Shata': ['pnina_tamano_sh', 'Kachol_Lavan', 'Female', 'תמנו-שטה', 24, '01/01/1981'],
